...
/* Layout for the activities page */
#activities-page {
  width: 100%;
  display: flex;
...
/* Style for individual donation cards */
.DonateCard {
  border-radius: 24px;
...
/* Style for icons used in donation cards */
#hand-heart-icon, #bank-icon, #heart-icon {
  color: var(--purple);
}
#hand-heart-icon {
  position: relative;
...
/* Style for the heart container and text at the bottom */
.heart-container {
  display: flex;
  margin: auto;
}
...
#quote-section {
  margin-top: 200px;
  margin-bottom: 200px;
  background-image: url('/assets/images/donate.jpeg');
  background-size: cover;
  width: 100%;
  height: calc(100vw / 2);
  color: var(--black);
...
#quote-container {
  ...
  flex-direction: row;
  align-items: start;
  margin: 5vw 10.42vw 7.34vw 8.7vw;
  color: white;
  width: 30vw;
}
